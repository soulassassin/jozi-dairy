...
const renderServiceIcon = (iconKey?: string) => {
  switch (iconKey) {
    case "milk":
      return <Milk className="w-4 h-4 shrink-0 text-jozi-cyan group-hover:text-white transition-colors" />;
    case "yoghurt":
      return <Layers className="w-4 h-4 shrink-0 text-jozi-cyan group-hover:text-white transition-colors" />;
    case "cream":
      return <Sparkles className="w-4 h-4 shrink-0 text-jozi-cyan group-hover:text-white transition-colors" />;
    case "amasi":
      return <Droplets className="w-4 h-4 shrink-0 text-jozi-green group-hover:text-white transition-colors" />;
    case "juice":
      return <Citrus className="w-4 h-4 shrink-0 text-jozi-amber group-hover:text-white transition-colors" />;
    case "blend":
    default:
      return <Package className="w-4 h-4 shrink-0 text-jozi-cyan group-hover:text-white transition-colors" />;
  }
};
...
export default function WhoWeAreBento({ onSelectCategory }: WhoWeAreBentoProps) {
  ...
  return (
    <section id="about" className="py-16 md:py-24 lg:py-28 bg-[#f4f7fb]/60 relative scroll-mt-24 md:scroll-mt-28">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            {SERVICE_BADGES.map((badge) => (
              <button
                ...
                className="group inline-flex items-center gap-2.5 px-5 py-3 rounded-full bg-white border border-slate-200 hover:border-jozi-cyan hover:bg-jozi-cyan hover:text-white text-jozi-navy shadow-sm transition-all hover:shadow-glow hover:-translate-y-0.5 text-sm font-semibold min-h-[48px] focus-visible:ring-2 focus-visible:ring-jozi-cyan focus:outline-none"
              >
                {renderServiceIcon(badge.iconKey)}
                <span>{badge.label}</span>
                <span className="text-[11px] px-2 py-0.5 rounded-full bg-slate-100 group-hover:bg-white/20 text-slate-500 group-hover:text-white transition-colors shrink-0">
                  {badge.count}
                </span>
              </button>
            ))}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-12 gap-6">
          ...
          <div className="md:col-span-3 lg:col-span-7 bg-white rounded-2xl md:rounded-3xl p-6 sm:p-8 md:p-10 border border-slate-200/80 shadow-soft flex flex-col justify-between relative overflow-hidden">
            ...
            <div>
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <h3 className="text-xl md:text-2xl font-bold text-jozi-navy font-display">
                    About Jozi Dairy
                  </h3>
                </div>
              </div>
              ...
              <p className="text-slate-700 text-base sm:text-lg leading-relaxed mb-6 font-medium text-pretty">
                &ldquo;{COMPANY_INFO.whoWeAre}&rdquo;
              </p>

              {/* Exact Verbatim Text 2 */}
              <p className="text-slate-600 text-sm sm:text-base leading-relaxed mb-8 text-pretty">
                {COMPANY_INFO.whoWeAreSecondary}
              </p>
            </div>

            <div className="pt-6 border-t border-slate-100 flex flex-wrap items-center justify-between gap-4">
              <div className="flex items-center gap-2 text-jozi-green text-sm font-semibold">
                <CheckCircle2 className="w-4 h-4 shrink-0" />
                <span>Certified Cold-Chain Distribution</span>
              </div>
              <a
                href="#contact"
                className="inline-flex items-center gap-1.5 text-sm font-semibold text-jozi-cyan hover:text-jozi-navy transition-colors py-1"
              >
          ...
          <div className="md:col-span-3 lg:col-span-5 bg-gradient-to-br from-jozi-navy to-jozi-navy-light text-white rounded-2xl md:rounded-3xl p-6 sm:p-8 md:p-10 shadow-card flex flex-col justify-between relative overflow-hidden">
            ...
            <div>
              ...
              {/* Exact Live Motto */}
              <h3 className="text-2xl sm:text-3xl lg:text-4xl font-bold tracking-tight mb-4 font-display text-balance">
              ...
              <div className="space-y-3 mb-6">
                <div className="flex items-center gap-3 text-sm text-slate-200">
                  <div className="w-2 h-2 rounded-full bg-jozi-cyan shrink-0"></div>
            ...
            <div className="pt-4 border-t border-white/10 flex flex-wrap items-center justify-between gap-4">
              ...
              <a
                ...
                className="min-h-[48px] px-6 py-3 rounded-xl bg-jozi-cyan hover:brightness-105 active:scale-[0.98] text-white text-sm font-semibold inline-flex items-center justify-center transition-all shadow-glow focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-jozi-cyan"
              >
                Inquire Rates
              </a>
            </div>
          ...
          <div className="md:col-span-1 lg:col-span-4 bg-white rounded-2xl md:rounded-3xl p-6 sm:p-7 border border-slate-200/80 shadow-soft flex flex-col justify-between">
            <div>
              <div className="w-12 h-12 rounded-2xl bg-amber-50 text-jozi-amber flex items-center justify-center mb-5 shrink-0">
            ...
            <div className="mt-6 pt-4 border-t border-slate-100 flex items-center justify-between text-xs font-semibold text-slate-500">
              ...
              <span className="text-jozi-amber font-bold">Grass-fed Quality</span>
            </div>
          </div>
          ...
          <div className="md:col-span-1 lg:col-span-4 bg-white rounded-2xl md:rounded-3xl p-6 sm:p-7 border border-slate-200/80 shadow-soft flex flex-col justify-between">
            <div>
              <div className="w-12 h-12 rounded-2xl bg-blue-50 text-jozi-cyan flex items-center justify-center mb-5 shrink-0">
            ...
            <div className="mt-6 pt-4 border-t border-slate-100 flex items-center justify-between text-xs font-semibold text-slate-500">
              ...
              <span className="text-jozi-cyan font-bold">Strictly 4°C</span>
            </div>
          </div>
          ...
          <div className="md:col-span-1 lg:col-span-4 bg-white rounded-2xl md:rounded-3xl p-6 sm:p-7 border border-slate-200/80 shadow-soft flex flex-col justify-between">
            <div>
              <div className="w-12 h-12 rounded-2xl bg-emerald-50 text-jozi-green flex items-center justify-center mb-5 shrink-0">
            ...
            <div className="mt-6 pt-4 border-t border-slate-100 flex items-center justify-between text-xs font-semibold text-slate-500">
              ...
              <span className="text-jozi-green font-bold">Personal Service</span>
            </div>
          </div>
        </div>
      </div>
